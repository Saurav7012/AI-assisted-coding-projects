      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          {visibleFields.map((field, index) => (
            <div key={field.id} className="border p-3 my-2">
              ...
              <input {...register(`visibleTestCases.${index}.explanation`)} placeholder="Explanation" className="input input-bordered w-full mb-2" />
              <button type="button" onClick={() => removeVisible(index)} className="btn btn-error btn-sm">Remove</button>
            </div>
          ))}
        ...
        <div>
          ...
          {hiddenFields.map((field, index) => (
            <div key={field.id} className="border p-3 my-2">
              ...
              <input {...register(`hiddenTestCases.${index}.output`)} placeholder="Output" className="input input-bordered w-full mb-2" />
              <button type="button" onClick={() => removeHidden(index)} className="btn btn-error btn-sm">Remove</button>
            </div>
          ))}
        ...
        {[0, 1, 2].map((index) => (
          <div key={index}>
            ...
            <textarea
              ...
              className="textarea textarea-bordered w-full mb-2 h-52"
            />
